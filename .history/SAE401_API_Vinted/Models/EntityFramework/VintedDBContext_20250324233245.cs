...
namespace SAE401_API_Vinted.Models.EntityFramework
{
    public partial class VintedDBContext : DbContext
    {
        ...
        {
            optionsBuilder.UseNpgsql("Host=Server=vinted-db.postgres.database.azure.com;Database=postgres;Port=5432;User Id=s4a21;Password={your_password};Ssl Mode=Require;; Database=VintedDB; Username=postgres; Password=postgres");
        }
