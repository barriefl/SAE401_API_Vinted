...
namespace SAE401_API_Vinted.Models.EntityFramework
{
    public partial class VintedDBContext : DbContext
    {
        ...
        {
            optionsBuilder.UseNpgsql("Host=vinted-db.postgres.database.azure.com;Database=postgres;;Username=s4a21;Password=SAE4;Ssl Mode=Require;; Database=VintedDB; Username=postgres; Password=postgres");
        }
