...
namespace SAE401_API_Vinted.Models.EntityFramework
{
    public partial class VintedDBContext : DbContext
    {
        ...
        {
            // optionsBuilder.UseNpgsql("Host=vinted-db.postgres.database.azure.com;Database=postgres;Username=s4a21;Password=SAE401_Vinted;Ssl Mode=Require;");
            optionsBuilder.UseNpgsql("Host=localhost; port=5432; Database=VintedDB; uid=postgres; password=postgres;");
        }
