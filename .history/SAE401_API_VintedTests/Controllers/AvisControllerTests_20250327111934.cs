...
namespace SAE401_API_Vinted.Controllers.Tests
{
    ...
    public class AvisControllerTests
    {
        ...
        public void PostAvis_ModelValidated_CreationOk()
        {
            ...
            //Act
            var result = controller.PostAvis(avisTestExist).Result;
            ...
            Assert.AreEqual(avisToGet, avisTestExist, "Les adresses ne sont pas identiques");
        ...
        public void GetAvisById_ExistingIdPassed_ReturnsRightItem_WithMoq()
        {
            ...
            mockAvisRepository.Setup(x => x.GetByIdAsync(1).Result).Returns(avisTest);
            ...
            Assert.AreEqual(avisTest, result.Value, "Avis pas identiques.");
        }
        ...
        public void PostAvis_ModelValidated_CreationOk_WithMoq()
        {
            ...
            var actionResult = mockAvisController.PostAvis(avisTest).Result;
            ...
            avisTest.AvisId = ((Avis)result.Value).AvisId;
            Assert.AreEqual(avisTest, (Avis)result.Value, "Utilisateurs pas identiques");
        }
    }
}