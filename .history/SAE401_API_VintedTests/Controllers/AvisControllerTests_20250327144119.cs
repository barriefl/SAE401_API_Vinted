...
namespace SAE401_API_Vinted.Controllers.Tests
{
    ...
    public class AvisControllerTests
    {
        ...
        public void PostAvis_ModelNotValidated_CreationNotOk()
        {
            ...
            Assert.IsInstanceOfType(actionResult.Result, typeof(BadRequestObjectResult), "Result n'est pas un BadRequestObjectResult");4

            Assert.AreEqual(((BadRequestObjectResult)actionResult.Result).Value, "Le commentaire de l'avis ne peut pas être vide", "Result n'est pas un BadRequestObjectResult");
