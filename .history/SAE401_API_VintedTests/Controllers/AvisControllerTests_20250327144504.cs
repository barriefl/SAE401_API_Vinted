...
namespace SAE401_API_Vinted.Controllers.Tests
{
    ...
    public class AvisControllerTests
    {
        ...
        public void PostAvis_ModelNotValidated_CreationNotOk()
        {
            ...
            Assert.IsInstanceOfType(actionResult, typeof(ActionResult<Adresse>), "Result n'est pas un action result");
            Assert.IsInstanceOfType(resuactionResultlt.Result, typeof(BadRequestObjectResult), "Result n'est pas un BadRequestObjectResult"); ;
