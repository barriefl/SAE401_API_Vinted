...
namespace SAE401_API_Vinted.Controllers.Tests
{
    ...
    public class AvisControllerTests
    {
        ...
        [TestMethod()]
        public void GetTypeAvisArticleTest()
        {
            //Arrange
            var lesTypesAvisArticle = context.TypesAvis.ToList();

            //Act
            var result = controller.GetTypesAvisArticles().Result;
            ...
            CollectionAssert.AreEqual(result.Value.ToList(), lesTypesAvisArticle, "Les listes d'avis ne sont pas égales");
        }
