...
namespace SAE401_API_Vinted.Controllers.Tests
{
    ...
    public class AvisControllerTests
    {
        ...
        public void Initialize()
        {
            ...
            mockAdresseRepository = new Mock<IAvisRepository>();
            mockAdresseController = new AdressesController(mockAvisRepository.Object);
        ...
        [TestMethod()]
        public void GetAvisByIdTest_Uncorrect()
        {
            //Arrange
