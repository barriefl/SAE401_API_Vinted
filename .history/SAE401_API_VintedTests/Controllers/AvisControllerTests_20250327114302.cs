...
namespace SAE401_API_Vinted.Controllers.Tests
{
    ...
    public class AvisControllerTests
    {
        ...
        public void GetTypeAvisByIdTest_Correct()
        {
            ...
            Assert.IsInstanceOfType(result, typeof(ActionResult<TypeAviss$>), "Result n'est pas un action result");
            Assert.AreEqual(result.Value, avis, "Les typeAvis ne sont pas égaux");
        }
